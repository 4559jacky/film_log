...
<nav aria-label="Page navigation-sm">
  <ul class="pagination justify-content-center">
    ...
    <c:if test="${paging.prev}">
      <li>
        <a class="pagination-newer" href="/qnaList?nowPage=${paging.pageBarStart - 1}" aria-label="Previous">
    ...
    <c:if test="${paging.next}">
      <li>
        <a class="pagination-older" href="/qnaList?nowPage=${paging.pageBarEnd + 1}" aria-label="Next">
